...
\input{Chapters/03_Theory/tables/standard_model}
...
proton, its constituent particles each carry some fraction, $x$, of the overall proton momentum. % At small x
% (momentum fraction) insert image of PDFs (see Phils/Luke's thesis)
...
The theory of topcolor is an example of a composite model theory, that suggests the existence of a
