...
\input{Chapters/04_Analysis/04b_XSections/tables/cutflow/cut_flow_7TeV_electron}
\input{Chapters/04_Analysis/04b_XSections/tables/cutflow/cut_flow_7TeV_muon}
\input{Chapters/04_Analysis/04b_XSections/tables/cutflow/cut_flow_8TeV_electron}
\input{Chapters/04_Analysis/04b_XSections/tables/cutflow/cut_flow_8TeV_muon}
...
to be unfolded. The log\abs{d_{i}} plots for \met variable at $\sqrt{s}=7\TeV$ is shown in
...
\begin{figure}[hbtp]
    \centering
	 ...
	 muon+jets channel (right) at $\sqrt{s}=8\TeV$. TODO: INSERT UPDATED PLOTS} %TODO:INSERT UPDATED PLOTS
